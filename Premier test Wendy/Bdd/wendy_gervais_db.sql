...
-- Généré le :  Ven 29 Avril 2022 à 00:48
...
(1, 'OE', 'Court-métrage IMAC 1', '', '', 1),
(2, 'TROU NOIR', 'Court-métrage IMAC 1', '', '', 1),
(3, 'Azurites', 'BD réalisée dans le cadre des 23H BD', '', '', 19);
...
--
ALTER TABLE `Oeuvres`
  MODIFY `id_oeuvre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
